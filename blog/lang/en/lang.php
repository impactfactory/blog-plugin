<?php return [
    ...
    'post' => [
        ...
        'slug' => 'Slug',
        'meta_title' => 'Meta Title',
        'meta_title_comment' => 'Eventually displayed in browser tab, Googles index, this websites search results, social media previews and json data',
        'meta_description' => 'Meta Description',
        'meta_description_comment' => 'Eventually displayed on Googles index, this websites search result, social media previews and json data.',
        'meta_keywords' => 'Meta Keywords',
        'meta_keywords_comment' => 'please separate with commas, max. 7',
        'meta_image' => 'Meta Image',
        'meta_image_comment' => 'Eventually displayed on social media previews, Googles index, this websites search results and json data',
